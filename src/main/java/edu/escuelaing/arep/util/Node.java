...
/**
 * La clase Node funciona como contenedor para un solo objeto dentro de un arreglo, 
 * tiene un valor y hace referencia al nodo siguiente dentro del mismo arreglo.
